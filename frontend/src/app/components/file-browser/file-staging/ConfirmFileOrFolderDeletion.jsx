...
function ConfirmFileOrFolderDeletion({
    ...
    return (
        <>
            <DialogRoot open={isConfirmDeleteModalOpen} onOpenChange={closeConfirmDeleteModal}>
                    ...
                    <Flex flexDirection='column'>
                                        ...
                                        <Table.Root {...TableStyle}>
                                            <Table.Body>
                                                ...
                                                <Table.Row {...SelectedDataRowStyle}>
                                                    ...
                                                    {deletedItem ? (
                                                        <Table.Cell>
                                                            {deletedItem.isFolder ? (
                                                                <>
                                                                    <Box key={deletedItem.data.path}>
                                                                        {deletedItem.data.path}
                                                                    </Box>
                                                                    {deletedItem.children.map((value, i) => (
                                                                        <Box key={i}>{value}</Box>
                                                                    ))}
                                                                </>
                                                            ) : (
                                                                <Box key={deletedItem.data.name}>
                                                                    {deletedItem.data.path}
                                                                </Box>
                                                            )}
                                                        </Table.Cell>
                                                    ) : (
                                                        <Table.Cell>All Files and Folders</Table.Cell>
                                                    )}
                                                </Table.Row>
                                            </Table.Body>
                                        </Table.Root>
                        ...
                        <DialogFooter minHeight='min-content'>
                            <Flex width='100%' alignItems='flex-end'>
                                ...
                                <Spacer />
                                <Box>
                                    <Button variant='subtle' onClick={closeConfirmDeleteModal} margin='5px'>
                                        Cancel
                                    </Button>
                                    <Button
                                        colorPalette='red'
...
export default ConfirmFileOrFolderDeletion;
